...
highlight NormalC   ctermfg=white   ctermbg=green  guifg=#61AFEF  guibg=#282C34
highlight InsertC   ctermfg=red    ctermbg=black  guifg=#E06C75  guibg=#282C34
highlight VisualC   ctermfg=yellow ctermbg=black  guifg=#E5C07B  guibg=#282C34
...
highlight Position  ctermfg=grey   ctermbg=black  guifg=#B2B2B2  guibg=#282C34
...
nnoremap <leader>o :wa \| vertical botright term ++kill=term<CR>
